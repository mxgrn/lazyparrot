...
config :lazyparrot, LazyparrotWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LazyparrotWeb.ErrorHTML, json: LazyparrotWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Lazyparrot.PubSub,
  live_view: [signing_salt: "e9B+Q8ZE"]
...
config :lazyparrot, Lazyparrot.Mailer, adapter: Swoosh.Adapters.Local
